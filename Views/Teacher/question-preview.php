        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Chi tiet cau hoi</h1>
                </div>
                    ...
                    <div class="col-8 offset-2">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary"><?php echo $question->content; ?></h6>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div id="buildyourform">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-7">
                                                    <input type="text" class="form-control-plaintext" placeholder="<?php echo $answer['content']; ?>" readonly>
                                                </div>
                                                <div class="form-group col-3">
                                                    <input type="text" class="form-control-plaintext" placeholder="<?php echo ($answer['is_right'] ? 'Right' : 'Wrong'); ?>" readonly>
                                                </div>
                                            </div>
                                            <?php } ?>
                                        </div>
